...
- 2026-03-23: `circuit` / `simulation` / `io` モジュールを実装。
- 2026-03-23: `src/bin/lgcell2/main.rs` に CLI を実装し、stdin/ファイル入力をサポート。
- 2026-03-23: モジュール単位の Unit テストと `tests/half_adder.rs` の統合テストを追加。
- 2026-03-23: `cargo test` で全テスト成功（21件）。
